USE [master]
GO
/****** Object:  Database [InventoryManagementSystem]    Script Date: 5/27/2024 9:32:36 PM ******/
...
GO
/****** Object:  Table [dbo].[Tbl_InventoryItem]    Script Date: 5/27/2024 9:32:36 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE TABLE [dbo].[Tbl_InventoryItem](
 ...
 CONSTRAINT [PK_Tbl_InventoryItem] PRIMARY KEY CLUSTERED 
(
	[ItemId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [dbo].[Tbl_InvetoryOrder]    Script Date: 5/27/2024 9:32:36 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[Tbl_InvetoryOrder](
	[OrderID] [int] IDENTITY(1,1) NOT NULL,
	[Items] [varchar](50) NOT NULL,
	[TotalPrice] [decimal](18, 2) NOT NULL,
 CONSTRAINT [PK_Tbl_InvetoryOrder] PRIMARY KEY CLUSTERED 
(
	[OrderID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
